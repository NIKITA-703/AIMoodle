...
def find_lecture_url(driver, target_topic_name, timeout=10):
    """
    ...
    target_clean = normalize_name(target_topic_name)
    ...
    try:
        ...
        btn = WebDriverWait(driver, 10).until(
            EC.element_to_be_clickable(
                (By.XPATH, "//button[contains(., 'Пройти тест') or contains(., 'Начать тестирование')]"))
        )
        btn.click()
        ...
        while True:
            ...
            if test_name and test_url:
                ...
                if topic_name:
                    ...
                    l_url = find_lecture_url(driver, topic_name)
